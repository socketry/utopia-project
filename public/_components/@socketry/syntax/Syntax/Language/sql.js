...
const sqlStyleComment = {
	pattern: /-- .*$/m,
	type: 'comment',
	allow: ['href']
};

const language = new Language('sql');

// SQL keywords (comprehensive list covering major SQL dialects)
const keywords = [
	'A',
	'ABORT',
	'ABS',
...
// SQL operators (longest first to match <= and >= before < and >)
const operators = ['!=', '<=', '>=', '=', '<', '>', '+', '-', '*', '/', '%'];

language.push(operators, {type: 'operator'});
language.push(sqlStyleComment);
